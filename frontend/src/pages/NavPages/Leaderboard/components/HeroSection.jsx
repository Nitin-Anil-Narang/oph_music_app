...
const HeroSection = ({ handleSearch, setArtistExists, artistExists, handleFilter }) => {
  ...
  return (
    <div className="relative sm:min-h-[55vh] w-full flex flex-col items-center justify-center text-white p-8 pt-20 pb-0 md:pt-0">
      {/* Background image */}
      <div
      ...
      <div className="relative z-20 max-w-3xl w-full mt-10 text-center space-y-6">
        ...
        */}
        ...
        {/* No Found message */}
        <div className="lg:h-6 mt-0 lg:mt-4">
