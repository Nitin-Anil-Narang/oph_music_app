    ...
    <div className="toppicks-section pt-10 bg-black z-20 relative text-white over lg:px-8">
      <div className="mx-auto">
        ...
        <div className="hidden md:block overflow-visible">
          <Slider {...settings} className="gap-6 overflow-visible">
            {Array.isArray(artistData) &&
              artistData.map((artist, index) => {
                  ...
                  <div
                    key={index}
                    className="lg:px-4 px-10 py-5 max-w-full sm:max-w-[95%] pt-8"
                  >
                    <div className="relative overflow-visible rounded-xl">
                      <div
                        className={`absolute left-[-10px] top-[-10px] z-50 ${rankToColor(
                          index + 1
                        )} w-16 h-16 flex items-center justify-center rounded-lg -rotate-12 pointer-events-none`}
                      >
        ...
        <div className="block md:hidden px-4 mb-16 overflow-visible">
          <div className="flex overflow-x-auto gap-4 pb-4 scrollbar-hide overflow-visible">
            {Array.isArray(artistData) &&
              artistData.map((artist, index) => {
                  ...
                  return (
                    <div key={index} className="flex-shrink-0 w-[300px] pt-8">
                      <div className="relative overflow-visible rounded-xl">
                        <div
                          className={`absolute left-[4px] top-[-10px] z-50 ${rankToColor(
                            index + 1,
                          )} w-16 h-16 flex items-center justify-center rounded-lg -rotate-12 pointer-events-none`}
                        >
                          <span className="text-black text-4xl font-bold">
                        ...
                        <div
                          className="relative h-[22rem] hover:cursor-pointer overflow-hidden rounded-t-xl"
                          onClick={(e) => {
                            e.stopPropagation();
                            console.log("Clicked artist:", artist.oph_id);
                            navigateToArtistDetail(navigate, artist.oph_id);
