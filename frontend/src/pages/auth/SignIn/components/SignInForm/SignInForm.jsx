...
const SignInForm = () => {
  ...
  useEffect(() => {
    if (location.state?.status === 'cancelled') {
      toast.error('Payment is mandatory. Please complete the payment to continue.');
  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl p-8 rounded-lg relative z-10">
        ...
        Hey family member, your personal portal is waiting for you, where every step leads you toward growth and success in your music career.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {showPassword ? (
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M6.58 6.58l10.84 10.84M3 3l18 18" />
                  </svg>
                ) : (
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            type="submit"
            className={`w-full py-2 px-4 ${loading ? "bg-gray-500 cursor-not-allowed" : "bg-cyan-400 hover:bg-cyan-500"
